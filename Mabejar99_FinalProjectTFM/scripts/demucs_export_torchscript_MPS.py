...
def main():
    # ============================================================
    # 1. Comprobar si MPS está disponible
    # ============================================================
    ...
    output_path = output_folder / "demucs_export_torchscript_MPS.pt"
    ...
    # Forzamos float32 porque MPS no trabaja bien con float64.
    ...
    # ============================================================
    # 6. Crear entrada de ejemplo EN MPS
    # ============================================================
    #
    # La forma usada será:
    #
    ...
    # Comprobamos que el modelo está en MPS.
